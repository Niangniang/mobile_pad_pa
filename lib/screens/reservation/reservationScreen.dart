...
class _ReservationScreenState extends State<ReservationScreen> {
  ...
  void initializer() {
    Provider.of<InfrastructureProvider>(context, listen: true)
        .getAllInfrastructures(context: context);
    Provider.of<TypeEvenementProvider>(context, listen: true)
        .getAllTypeEvenements(context: context);
  }
              ...
              const Row(
                ...
                children: [
                  Expanded(
                    ...
                    child: Padding(
                      padding:
                          EdgeInsets.only(left: 0, right: 0, top: 3, bottom: 5),
                      child: Text(
                        'Nom de l\'événement',
                  ...
                  Expanded(
                    ...
                    child: Row(
                      children: [
                        ...
                        const SizedBox(
                            width: 8), // Espacement entre les deux colonnes
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
    ...
    return Container(
      ...
      child: ElevatedButton(
        onPressed: () {
          ...
          Provider.of<InfrastructureProvider>(context, listen: true)
              .setSingleInfra(infrastructure);
          debugPrint(
              "select infra ==> ${Provider.of<InfrastructureProvider>(context, listen: true).infra}");
        },
